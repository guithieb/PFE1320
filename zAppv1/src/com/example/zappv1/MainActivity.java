...
public class MainActivity extends FragmentActivity {
	...
	final String[] data ={"Liste des chaÓnes","Favoris","CatÈgoris","Gestion des alertes","Mes rÈglages"};
    ...
    public void handleMessage(Message inputMessage) {
      ...
      // On supporte de la part de la page HTML quelques ordres, qui vont etre envoyes au thread de l'activité.
    ...
    setContentView(R.layout.activity_main);
		...
		/*** Module ID IP tÈlÈphone ***/
		// On lance la librairie qui gËre les devices, avec la callback pour les notifications natives
		DeviceWatcher deviceWatcher = DeviceWatcher.getInstance(getApplicationContext()/*,MainActivity.class,R.drawable.ic_launcher*/);
		// On crÈe pour cela un DeviceManager
