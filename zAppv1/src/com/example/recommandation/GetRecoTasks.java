...
public class GetRecoTasks extends AsyncTask<String, Void, String>{
		...
		public GetRecoTasks(ArrayList<EPGChaine> chaines, BaseAdapter adapter, Context c, String channels) {
